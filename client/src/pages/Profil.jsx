...
const Icone = {
  ...
  badge: (p) => (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={p.className}><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z"/></svg>),
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="rounded-2xl overflow-hidden shadow bg-white dark:bg-gray-800 mb-6">
        ...
        <div className="px-6 pb-6">
          ...
          <div className="w-20 h-20 -mt-10 rounded-full ring-4 ring-white dark:ring-gray-800 bg-gradient-to-br from-primaire to-marine grid place-items-center text-2xl font-bold text-white">
            {initiales || '?'}
          </div>

          {/* Identité (entièrement sous le bandeau, sur fond blanc) */}
          <div className="mt-3">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{user?.structure || 'Natixis Algeria'}</p>
          </div>
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-1.5 mt-4">
            ...
            <span className="inline-flex items-center gap-1.5 text-sm text-gray-600 dark:text-gray-300">
              <Icone.badge className="w-4 h-4 shrink-0 text-gray-400" /> {STAT_DEMANDES_LIBELLE[user?.role] || 'Demandes'} : {nbDemandes === null ? '…' : nbDemandes}
            </span>
            <span className="inline-flex items-center gap-1.5 text-sm text-gray-600 dark:text-gray-300">
