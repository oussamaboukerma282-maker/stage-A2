...
export default function Profil() {
  ...
  const Ligne = ({ label, valeur }) => (
    <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
      ...
      <span className="font-medium text-gray-800 dark:text-gray-100">{valeur}</span>
    </div>
  );

  return (
    <div className="max-w-xl">
      <h1 className="text-2xl font-bold text-marine dark:text-purple-300 mb-6">Mon profil</h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h2 className="font-semibold text-gray-700 dark:text-gray-200 mb-3">Changer mon mot de passe</h2>
